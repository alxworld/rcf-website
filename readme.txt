...
RCF (Ramapuram Corporate Fellowship) is a website template customized from the Hesed template.
It provides essential pages and features to present the Ramapuram Corporate Fellowship (RCF) online.
The template is easy to use and the code is commented and organized for customization.
If you are building a site for RCF or a similar fellowship, this customized template is ready to use.
...
Since RCF (based on the Hesed template) is distributed for free, support is not offered. The
original template is coded according 
